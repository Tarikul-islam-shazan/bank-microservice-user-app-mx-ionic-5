...
export class AddPayeeFacade {
  ...
  continue(billPayee: IBillPayee): void {
    ...
    this.navigateToPage('/move-money/mail-check/add-payee-address');
  }
  ...
  private generateDeleteConfirmationComponentProp(): IMeedModalContent {
    const componentProps: IMeedModalContent = {
      contents: [
        {
          title: '',
          details: ['move-money-module.mail-check.add-payee.modal.delete-payee-title']
        }
      ],
      actionButtons: [
        {
          text: 'move-money-module.mail-check.add-payee.modal.yes-button',
        ...
        {
          text: 'move-money-module.mail-check.add-payee.modal.no-button',
