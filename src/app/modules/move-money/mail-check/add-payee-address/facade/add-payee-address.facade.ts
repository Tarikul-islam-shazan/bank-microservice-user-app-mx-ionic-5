...
export class AddPayeeAddressFacade {
  ...
  private getAddPayeeSuccessModalCompProps(billPayee: IBillPayee): IMeedModalContent {
    ...
    const componentProps: IMeedModalContent = {
      contents: [
        {
          title: 'move-money-module.mail-check.add-payee.modal.content',
          values: { addPayeeDeliveryInterval }
        }
      ],
      actionButtons: [
        {
          text: 'move-money-module.mail-check.add-payee.modal.payment-button',
          cssClass: 'grey-outline-button',
          handler: () => {
            this.payBillService.billPayee = billPayee;
            this.modalService.close();
            this.navigateToPage('/move-money/mail-check/bill-payment');
          }
        },
        {
          text: 'move-money-module.mail-check.add-payee.modal.done-button',
